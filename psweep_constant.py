...
params['tau'] = np.array([0.6, 1.4])
params['tau_F'] = 1.
params['tau_SG'] = np.array([48, 800])
# params['tau_SG'] = 
params['tau_SR'] = np.array([48, 800])

# params['m0'] = 2.5
params['m0'] = np.array([2., 10.])
params['x0'] = 0.2
params['a0'] = 0.5
params['a_max'] = 50 # np.array([5,100])
...
# params['tau_R0'] = np.linspace(100, 800, 10)
# params['TV0SR'] = 0.1
# params['TV0SG'] = np.linspace(0.05, 0.8, 7)
...
loop_over = ['m0', 'tau_SR', 'tau_SG', 'tau', 'ptime', 'n']
derivative = ['tau_F', 'pstiff', 'mstiff']
